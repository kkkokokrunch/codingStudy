...
import 'package:flutter_app/douban/utils/log.dart';
import 'package:flutter_app/douban/widgets/dash_line.dart';
import 'package:flutter_app/douban/widgets/stars_rating.dart';


class ZHHomeMovieItem extends StatelessWidget {
  final MovieItem movie;

  ZHHomeMovieItem(this.movie);
  ...
  Widget buildContentInfoTitle() {
    zhLog("aaaaaa", StackTrace.current);
    ...
    return Text.rich(
        TextSpan(children: [
          ...
          ...movie.title.runes.map((rune) { //runes拿到了每一个文字的编码
            return WidgetSpan(
                child: Text(
